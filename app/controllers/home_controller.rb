class HomeController < ApplicationController
  ...
  private
    ...
    def refreash_user_account (twitter_id)
      ...
      write_to_api_call_log("Called the users/show end point to refresh data on " + twitter_id, true, '/users/show', twitter_id, 1)
    ...
    def add_followers (twitter_id)
      ...
      loop do
        ...
        if i['errors'] != nil
            ...
            write_to_api_call_log("Follower data was successfully retrived for twitter id: " + twitter_id, true, '/followers/list', twitter_id, i['users'].count)
        end
    ...
    def add_following (twitter_id)
      ...
      loop do
        ...
        if i['errors'] != nil
            ...
            write_to_api_call_log("Following data was successfully retrived for twitter id: " + twitter_id, true, '/friends/list', twitter_id, i['users'].count)
        end
    ...
    def write_to_api_call_log (message, successful, path, handle, records_inserted)
      ...
      @api_call_log.RecordsInserted = records_inserted
