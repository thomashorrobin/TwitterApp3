...
class FollowersControllerTest < ActionController::TestCase
  ...
  test "should create follower" do
    assert_difference('Follower.count') do
      post :create, follower: { display_name: @follower.display_name, references: @follower.references, twitter_id: @follower.twitter_id, username: @follower.username }
    end
  ...
  test "should update follower" do
    patch :update, id: @follower, follower: { display_name: @follower.display_name, references: @follower.references, twitter_id: @follower.twitter_id, username: @follower.username }
    assert_redirected_to follower_path(assigns(:follower))
  end
