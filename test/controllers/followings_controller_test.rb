...
class FollowingsControllerTest < ActionController::TestCase
  ...
  test "should create following" do
    assert_difference('Following.count') do
      post :create, following: { display_name: @following.display_name, references: @following.references, twitter_id: @following.twitter_id, username: @following.username }
    end
  ...
  test "should update following" do
    patch :update, id: @following, following: { display_name: @following.display_name, references: @following.references, twitter_id: @following.twitter_id, username: @following.username }
    assert_redirected_to following_path(assigns(:following))
  end
